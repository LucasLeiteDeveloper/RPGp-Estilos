...
Tenha em mente que devido as regras **Regras de Divulgação de Extensões** os estilos que você for usar na extensão não podem alterar quaisquer customizações comerciáveis da plataforma, como fundo das fichas, bandeja de dados, ou moldura de perfil. Ou seja, **não é possível utilizar imagens** em seus estilos e também **não é possivel importar fontes de texto**, pois não consegui encontrar uma forma eficiente de diferenciar URLs de imagens - que são proíbidas - e URLs de fonte.